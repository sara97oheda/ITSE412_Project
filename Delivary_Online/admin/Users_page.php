    ...
    <div class="navbar-default sidebar" role="navigation" style="font-family:Hacen Algeria; background:white;">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#" class="waves-effect"><img src="image/icons8_User_Groups_20px.png" style="padding-left: 15px;"/>المستخدمين</a>
                </li>
                <li>
                ...
                <div class="">
                    <div class="col-sm-12"">
                            <div class="pull-left"><button type="button" class="btn btn-md btn-primary" id="command-add" data-row-id="0">
                                    <span class="glyphicon glyphicon-plus"></span> اضافة مستخدم جديد</button>
                            </div>
                        <table id="employee_grid" class="table table-condensed table-hover table-striped" width="60%" cellspacing="0" data-toggle="bootgrid">
                            ...
                            <tr style="text-align: right;">
                                ...
                                <th data-column-id="passWord">كلمة المرور</th>
                                <th data-column-id="Email">البريد الالكتروني</th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" id="frm_add">
                                ...
                                <div class="form-group">
                                    <label for="salary" class="control-label">كلمة المرور:</label>
                                    <input type="text" class="form-control" id="salary" name="salary" required/>
                                </div>
                                <div class="form-group">
                                    <label for="salary" class="control-label">البريد الالكتروني:</label>
