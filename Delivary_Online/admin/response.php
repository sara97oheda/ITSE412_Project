...
<?php
	...
	function insertEmployee($params) {
		$data = array();;
		$sql = "INSERT INTO `users` (username, passWord, Email) VALUES('" . $params["name"] . "', '" . $params["salary"] . "','" . $params["age"] . "');  ";
	...
	function updateEmployee($params) {
		$data = array();
		//print_R($_POST);die;
		$sql = "Update `users` set username = '" . $params["edit_name"] . "', passWord='" . $params["edit_salary"]."', Email='" . $params["edit_age"] . "' WHERE id='".$_POST["edit_id"]."'";
